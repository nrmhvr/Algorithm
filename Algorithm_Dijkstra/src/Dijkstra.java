...
public class Dijkstra {
	static String[] txt = null; // txt파일 읽기용ㄹ
	static int num = 0; // 정점 개수
	static ArrayList<Node> Q = null; // 우선순위 큐
	static ArrayList<Node> S = null; // 계산 완료된 점 집합
	static int[][] w = null; // weight

	public static void main(String[] args) {
		// read
		try (FileInputStream fstream = new FileInputStream("data12.txt")) {
	...
	// 문자로 변경
	private static char toASCII(int key) {
		int asc = key + 64;
		return (char) asc;
	}
